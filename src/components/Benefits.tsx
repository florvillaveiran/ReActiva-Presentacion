    ...
    <section className="h-full px-6 flex flex-col justify-center items-center bg-brand-cream overflow-hidden py-10">
      <div className="max-w-7xl w-full">
        <motion.div 
           ...
           className="mb-8"
        >
          <span className="text-brand-primary font-bold text-[10px] uppercase tracking-widest mb-2 block">IMPACTO REAL</span>
          <h2 className="font-display text-4xl text-brand-on-surface font-bold mb-3 tracking-tight">Beneficios comprobados.</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
             <div className="p-8 flex-1 flex flex-col justify-between">
                <div>
                   ...
                   <h3 className="font-display text-2xl font-bold mb-3 tracking-tight">Mejora la productividad.</h3>
                   <p className="text-brand-on-surface-variant text-xs font-medium leading-relaxed mb-6">
                ...
                <div>
                   ...
                   <p className="text-[#2E7D32] font-bold text-[9px] uppercase tracking-widest text-right">85% Eficiencia</p>
                </div>
             </div>
             <div className="lg:w-2/5 h-full min-h-[200px]">
                <img src="https://images.unsplash.com/photo-1542744094-24638eff58bb?auto=format&fit=crop&q=80&w=1000" alt="Meetings" className="w-full h-full object-cover" />
             </div>
          </motion.div>
          ...
          >
             <div>
                ...
                <h3 className="font-display text-xl font-bold mb-2 tracking-tight leading-tight">Reducción del ausentismo.</h3>
                <p className="text-brand-on-surface-variant text-[10px] font-medium leading-relaxed">
                   Disminuye las bajas por estrés y fatiga crónica mediante bienestar preventivo.
                </p>
             </div>
             <div className="mt-6 bg-slate-50 p-4 rounded-xl flex items-center justify-between">
                <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Impacto Anual</span>
                <span className="text-pink-600 font-bold text-lg">-32%</span>
             </div>
          </motion.div>
          ...
          >
             <div>
                ...
                <h3 className="font-display text-xl font-bold mb-2 tracking-tight leading-tight">Menor rotación anual.</h3>
                <p className="text-brand-on-surface-variant text-[10px] font-medium leading-relaxed">
          ...
          >
             ...
             <div className="max-w-md">
                <h3 className="font-display text-2xl font-bold mb-3 tracking-tight">Mayor percepción positiva.</h3>
